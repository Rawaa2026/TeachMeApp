...
/**
 * مركز المعلم: دروسي، الجدول، طلبات الانضمام — ضمن تبويبات لتقليل عناصر الشريط السفلي.
 */
public class TeacherHubFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        pager.setAdapter(new FragmentStateAdapter(this) {
            ...
            public Fragment createFragment(int position) {
                switch (position) {
                    ...
                    case 2:
                    default:
                        return new TeacherRequestsFragment();
                }
            }
        ...
        tabMediator = new TabLayoutMediator(tabs, pager, (tab, position) -> {
            if (position == 0) {
                tab.setText(R.string.nav_my_lessons);
            } else if (position == 1) {
                tab.setText(R.string.nav_schedule);
            } else {
                tab.setText(R.string.nav_join_requests);
            }
        });
        tabMediator.attach();
    }
